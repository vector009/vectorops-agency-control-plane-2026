...
function config() {
  ...
  const anonCandidate = process.env.VITE_SUPABASE_PUBLISHABLE_KEY || process.env.SUPABASE_PUBLISHABLE_KEY || process.env.SUPABASE_ANON_KEY || process.env.VITE_SUPABASE_ANON_KEY;
  return {
    url: !isPlaceholder(urlCandidate) ? urlCandidate : DEFAULT_SUPABASE_URL,
    anonKey: !isPlaceholder(anonCandidate) ? anonCandidate : DEFAULT_SUPABASE_PUBLISHABLE_KEY,
